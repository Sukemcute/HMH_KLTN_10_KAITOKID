# Verification: Layer 20 (SCDown Block)

This document details the exhaustive verification of the `SCDown` mapping for Layer 20 of the qYOLOv10n model using the full inference resolution.

## 1. Layer 20 Configuration
- **Type:** SCDown
- **Output Shape (Inference):** [1, 128, 20, 20]
...
## 4. Conclusion
Layer 20 logic is mathematically confirmed against the reference PyTorch model at full spatial scale.

**Verification Script:** `verify_layer_20.py`
