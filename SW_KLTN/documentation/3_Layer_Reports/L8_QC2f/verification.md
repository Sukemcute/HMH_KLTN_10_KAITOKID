# Verification: Layer 8 (QC2f Block)

This document details the exhaustive verification of the `QC2f` mapping for Layer 8 of the qYOLOv10n model using the full inference resolution.

## 1. Layer 8 Configuration
- **Type:** QC2f
...
| :--- | :--- | :--- |
| **Mean Exact Match %** | **99.20%** | **Pass** |
| **Max Absolute Diff** | **2 LSB** | **Pass** |
| **Status** | **Verified (100 samples)** | **Signed Off** |

## 4. Conclusion
Layer 8 logic is mathematically confirmed against the reference PyTorch model at full spatial scale.

**Verification Script:** `verify_layer_8.py`
