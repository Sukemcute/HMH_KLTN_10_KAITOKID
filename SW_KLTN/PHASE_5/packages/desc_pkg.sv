`timescale 1ns/1ps
// PHASE_5 — giữ nguyên layout 64B/net|layer|tile descriptor như PHASE_3.
// Gợi ý tích hợp PPU qua DDR (cùng AXI master): dùng aux_arena_base hoặc vùng do toolchain
// map; tránh thêm trường vào net_desc_t nếu không đổi kích thước khối 64 byte trong desc_fetch.
package desc_pkg;
  import accel_pkg::*;
