`timescale 1ns/1ps
// PHASE_5 — bản sao từ PHASE_3; giữ đồng bộ với RTL compute cho đến khi bạn chỉnh riêng PHASE_5.
package accel_pkg;
  ...
  parameter int MACS_PER_SUB   = PE_ROWS * PE_COLS * LANES;
  parameter int DSP_PAIRS      = LANES / 2;
